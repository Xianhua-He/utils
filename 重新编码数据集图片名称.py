...
if __name__ == '__main__':
  ...
  root_img = '/mnt/lustre/share_data/image_bak'
  root_label = '/mnt/lustre/share_data//annotation_bak'

  out_img = '/mnt/lustre/share_data/image' 
  out_label = '/mnt/lustre/share_data/annotation'

  #task_list = [1047, 1186, 1187, 1188, 1231, 462, 475, 563, 815, 869, 982]
  task_list = [982]
  ...
  for task_id in task_list:
    ...
    #print('Task_%s image rename successed!(%d images)'%(task_id,count))
    #
    #count = 0
    ...
    #print('Task_%s label rename successed!(%d labels)'%(task_id,count))
